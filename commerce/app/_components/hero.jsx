  ...
  <div className="mx-auto w-screen max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8 lg:py-32">
    <div className="mx-auto max-w-prose text-center">
      <h1 className="text-4xl font-bold text-gray-900 sm:text-5xl dark:text-white">
        ...
        <strong style={{color:"var(--prymary)" }}> increase </strong>
        conversions
      </h1>
      ...
      <div className="mt-4 flex justify-center gap-4 sm:mt-6">
        <a className="inline-block rounded border  px-5 py-3 font-medium text-white shadow-sm transition-colors hover:bg-indigo-700" 
        style={{background:"var(--prymary)",borderColor:"var(--prymary)"}}
        href="#">
          Get Started
        </a>
